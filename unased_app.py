...
def run():
    ...
    def load_model_and_tokenizer():
        tokenizer = BertTokenizer.from_pretrained("uncased_Model_folder", local_files_only=True)
        model = BertForSequenceClassification.from_pretrained("uncased_Model_folder", local_files_only=True)
        model.eval()
